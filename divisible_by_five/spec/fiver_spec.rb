...
describe Fiver do
  ...
  let(:fiver) { Fiver.new(inputs) }

  it "returns whether the products of the inputs is divisible by five" do
    expect(fiver.divis?).to eql(true)
  end
end
